...
print(final_count)
percent_ingroup_neighbors = np.round((np.arange(51, 41, -1) / 52)*100, decimals = 2)
print(percent_ingroup_neighbors)
#plot
plt.plot(percent_ingroup_neighbors,final_count, linestyle='-', marker='o', color='#004182')
plt.gca().invert_xaxis()
plt.xlabel('% Ingroup neighbors', fontsize=20)
plt.xticks([96.15, 92.31, 88.46, 84.62, 80.77],['96.15','92.31','88.46','84.62','80.77'], fontsize=12)
